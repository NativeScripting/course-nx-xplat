...
import { CoreModule, PlatformLanguageToken, PlatformWindowToken } from '@nuvious/core';
...
export class NuviousCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: NuviousCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'NuviousCoreModule');
  }
}
